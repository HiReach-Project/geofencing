...
### You can find here a less technical documentation : [Geofencing API Documentation](https://github.com/HiReach-Project/geofencing/blob/master/Geofencing%20API%20documentation.pdf) 
...
The public directory contains a demo web app. To access it after the project is up go to [localhost:8000/demo.html](http://localhost:8000/demo.html)
